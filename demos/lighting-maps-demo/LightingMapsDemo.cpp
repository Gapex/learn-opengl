...
void CLASS_NAME::Init() {
    ...
    m_light_program.AddShader(GL_VERTEX_SHADER, PROJECT_DIR "demos/lighting-maps-demo/light.vertex.glsl");
    m_light_program.AddShader(GL_FRAGMENT_SHADER, PROJECT_DIR "demos/lighting-maps-demo/light.frag.glsl");
    if (!m_light_program.Init()) {
        return;
    }
    m_cube_program.AddShader(GL_VERTEX_SHADER, PROJECT_DIR "demos/lighting-maps-demo/lighting-cube.vertex.glsl");
    m_cube_program.AddShader(GL_FRAGMENT_SHADER, PROJECT_DIR "demos/lighting-maps-demo/lighting-cube.frag.glsl");
